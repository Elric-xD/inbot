...
class Call(PyTgCalls):
    ...
    async def speedup_stream(self, chat_id: int, file_path, speed, playing):
        ...
        if str(db[chat_id][0]["file"]) == str(file_path):
            ...
            raise AssistantErr("AYOOOOO NOOB")
        if str(db[chat_id][0]["file"]) == str(file_path):
    ...
    async def join_call(
        ...
        try:
            ...
            raise AssistantErr(
                "**ᴘʟᴇᴀsᴇ sᴛᴀʀᴛ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴏғ ʏᴏᴜʀ ᴄʜᴀᴛ ᴀɴᴅ ᴘʟᴀʏ ᴀɢᴀɪɴ.**"
            )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**ᴀssɪsᴛᴀɴᴛ ᴀʟʀᴇᴀᴅʏ ɪɴ ᴠɪᴅᴇᴏᴄʜᴀᴛ**\n\nᴘʟᴇᴀsᴇ ᴘʟᴀʏ ᴀɢᴀɪɴ ᴏʀ ᴄʟɪᴄᴋ ᴏɴ /reboot"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**ᴛᴇʟᴇɢʀᴀᴍ sᴇʀᴠᴇʀ ᴇʀʀᴏʀ**\n\nᴩʟᴇᴀsᴇ ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴏғ ʏᴏᴜʀ ᴄʜᴀᴛ."
            )
